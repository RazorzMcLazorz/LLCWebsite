  ...
  project(project) {
    return (
      <div className='mobProject-box'>
        <div className='mobProject-title'>{this.props.projects.title[project]}</div>
        <div className='mobProject-details'>
          <div className='mobProject-description'>{this.props.projects.summary[project]}</div>
        ...
        <div className='mobProject-date'>{this.props.projects.date[project]}</div>
      </div>
    )
  }
