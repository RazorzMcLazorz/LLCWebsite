          ...
          <div className='skillsMobMiddle'>
            <div className='skillsMobBox'>
              ...
              <div className='skillsMobBoxContent'>
                ...
                between pages. With React I know how to manage the State and the this statement
                while within the class components. Redux is an addition to React to allow everything
                to be put into the store and distriputed to all files allowing seemless data
            ...
            <div className='skillsMobBox'>
              ...
              <div className='skillsMobBoxContent'>
                I can take a Website Assignment and using React build a completely functional
                websites fit with connections between a DataBase and the Website being able to
                respond to user logins / Admin logins using CSS and HTML make the Website look
                Decent built to your liking, and how you want it to look I can change to fit today's
                designs.
              </div>
            </div>
          </div>
...
SkillsMob = connect(mapStateToProps, actions)(SkillsMob)
