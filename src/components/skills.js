        ...
        <div id='skillsDetails'>
          <div className='skillsMiddle'>
            ...
            <div className='skillsBox'>
              ...
              <div className='skillsBoxContent'>
                <p>
                  ...
                  that is Redux allowing me to store variables in a Redux store that connects
                  everywhere instead of duplicating it. with this knowledge, I spent making projects
                  like Black Jack as a website hosted by Heroku, and many others.
                </p>
              </div>
            </div>
            <div className='skillsBox'>
              ...
              <div className='skillsBoxContent'>
                <p>
                  ...
                  Black Jack Game{' '}
                  <a target='_blank' href='https://repl.it/@Razorz/BlackJack'>
            ...
            <div className='skillsBox'>
              ...
              <div className='skillsBoxContent'>
                <p>
                  My Coding Career started when I joined a Coding BootCamp called Bottega.tech in
                  July of 2018 to October of 2018, where I graduated from the class and started
                  working with a Company Called RoviTracker, I started working here November of 2018
                  till now. My Experience level, in my opinion, is at a junior to mid-level as I'm
                  at the point where I can create a fully functional website and iterate on it and
                  make it follow specific guidelines, this website your reading this on doesn't use
                  too much material-UI in it as I'm trying to show my React, Redux, SCSS skills.
                </p>
              </div>
            </div>
          </div>
