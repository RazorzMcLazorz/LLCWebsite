...
const initialState = {
  ...
  projects: {
    ...
    summary:{
      ...
      'madlibs' : "Madlibs uses this.state.values and changes the state by setState to the value. Its a Madlibs game hosted on the web, it shows basic React.JS of taking input and putting in the correct spots to make a nice little story.",
      'hjreptiles' : "This is one of my clients websites im currently working on, right now we are in the Drafting stage so i have no pictures to display. But this website will be where he can show off all his Reptiles and sell them to his clients.",
      'medicy' : 'A City Builder Game placed inside medieval times, and the ability, to manage your city from the ground up. this is currently in building stages. and not fully complete you can see the current progress with the links on the left.'
    },
    date: {
